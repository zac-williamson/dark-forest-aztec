...
const candidateName=process.argv[2]??'candidate';
...
const notes=[
 ...
 'Candidate results are shown only after original event order, tags, IDs, every state field and resulting roots pass comparison. Failed or incomplete verification never counts as savings.',
