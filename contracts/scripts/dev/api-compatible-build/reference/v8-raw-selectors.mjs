...
const backendRoutes=['commit_plan_small','commit_plan_medium','commit_plan','try_settle_give_spaceships'];
const unusedBackendRoutes=['try_settle_initialize_new','try_settle_refresh_empty'];
...
const report={passed:true,scope:'Native ABI selector comparison only; does not replace authorization or state-equivalence execution tests',workerTargets:2,backendTargets:4,unusedWorkerRoutes,unusedBackendRoutes,checked};
